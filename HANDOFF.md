...
- Workshop and Review are implemented only through M5.5. Review has real Proposal inbox/detail/decision flows, and Workshop has durable sessions/messages/context baskets/context preview/single-role calls plus Workshop-to-Proposal deep links and source-message status sync. Tool Plans/Grants, Council, and final user visual acceptance are incomplete.

Current boundaries:

- M5.1-M5.5 are command/function verified as of 2026-07-01. M5 Workshop/Proposal/Review is not complete or visually accepted; next slice is M5.6.
