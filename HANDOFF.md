...
- Current planning decision: the prior "do not start NS-410" warning is superseded by explicit user direction on 2026-06-26. M2/M3 foundations can be modified for the JSON authority, block document, and unified Progression change. Slices 1-8 and the Slice 7A audit repair are implemented on the NS-410 branch; continue with Slice 9 unless the user redirects.
...
- Write now has ordinary blocks, embedded progression blocks, and a current-scene progression panel for field Progression records.
