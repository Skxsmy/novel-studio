...
- Next mainline action: A04 through A07 real-author behavior and adversarial boundaries are passed after live defects were repaired; implement A08 cancellation, Provider failure, restart reconciliation, stale citation, database deactivation, explicit retry, and no-hidden-replay closure next.
