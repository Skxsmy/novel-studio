...
- M5.1-M5.5 are command/function verified after post-M5.5 audit repair. Proposal v2 extends the existing Proposal contract, Proposal/Review storage and routes exist, Review uses real Proposal APIs including stale marking, full patch review, and batch result display, Workshop persists sessions/messages/context baskets and can run single-role calls through existing context/model-call paths, and Workshop messages can create durable Proposal cards with exact Review/source-message deep links through a transactional source-message link write. User visual acceptance remains pending.
...
- Review and Workshop are implemented only through the M5.5 scope. Review decision flows, Workshop session/context/single-role calls, Workshop-generated Proposal cards, exact source-message deep links, and status sync are command/function verified, but Tool Plans, Grants, Council, and final user visual acceptance remain incomplete.
