...
- Active task: `NS-607 / M6.6 Workshop Research Database Integration`; ADR-0023, the direct-code Workshop checklist, harness design, and A01-A15 exact acceptance mapping are frozen before runtime edits.
...
- Next mainline action: implement NS-607 contracts and storage authority for session version 3 activation, transactional migration/rollback, diagnostics, lifecycle references, and message evidence before server Provider loops or UI edits.
