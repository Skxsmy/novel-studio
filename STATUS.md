...
- Next mainline action: A04 cross-language continuity and A05 natural-correction/Codex are each 3/3 passed after live defects were repaired; implement and run A06 balanced-triggering/conflicting-source trials, then continue adversarial, recovery, performance, connected UI, and final audit closure.
