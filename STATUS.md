...
- Next mainline action: A03 through A09 are passed, including real-author behavior, adversarial/recovery boundaries, and the declared 25 MiB exact plus 4,096-Chunk vector performance gates; run A10 on an identified temporary server in the real in-app browser next.
