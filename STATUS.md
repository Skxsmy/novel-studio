...
- Next mainline action: A04 cross-language continuity, A05 natural-correction/Codex, and both A06 balanced-triggering/conflicting-source scenarios are each 3/3 passed after live defects were repaired; implement A07 prompt-injection, permission, inactive-database, malformed/broad/duplicate/cross-target adversarial closure next.
