...
- M3：进行中。`NS-301`、`NS-302` 已验收，下一项是 `NS-303`。
...
详细证据：`docs/testing/NS-301_ACCEPTANCE.md`、`docs/testing/NS-302_ACCEPTANCE.md`。
...
`NS-303`：接入 Milkdown、Sections、专注写作与审阅锚点模型，同时保持 Markdown 文件权威与 revision 冲突保护。
