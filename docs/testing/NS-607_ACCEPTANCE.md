...
| NS-607-A14 | in_progress | repository commands | focused suites, one final full check/build, and documentation/link checks pass; diff safety, exact staging/commit, and clean-state evidence remain |
