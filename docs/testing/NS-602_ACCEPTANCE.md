...
| NS-602-A12 | passed | Web/browser/manual | component accessibility assertions, desktop/compact diagnostics, explicit author visual decision | Keyboard-labeled controls and 960/720-pixel no-overflow layouts passed diagnostics; on 2026-07-19 the author accepted the overall connected Research layout and opened broader formats plus isolated library-level databases as later scope |
...
| 2026-07-19 | committed NS-602 at `bb37126` plus GOV-002 at `8d62932` | Show the connected empty Research workspace in the visible local application and request the author's explicit visual decision | Author response: overall page accepted; request for Word, PDF, web links, and multiple Series-independent isolated Research Databases recorded as NS-603/NS-604 scope |
