...
| NS-604 | in_progress | M6.3 durable Source authority, large-file ingestion, bounded reading, and isolated original-language lexical index; A01-A13 pass in the task worktree, while task-scoped commits and author A14 remain open | `docs/tasks/NS-604.md`; `docs/testing/NS-604_ACCEPTANCE.md` |
