...
| NS-604 | in_progress | M6.3 durable Source authority, large-file ingestion, bounded reading, exact-match navigation, and isolated original-language lexical index; A01-A13 pass, while the latest correction commit and author A14 remain open | `docs/tasks/NS-604.md`; `docs/testing/NS-604_ACCEPTANCE.md` |
