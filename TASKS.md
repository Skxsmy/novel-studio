...
| NS-609 | paused | Unrequested agent-added Research Note and Codex promotion expansion; implementation evidence A01-A11 exists, but the feature is frozen under ADR-0026 pending an explicit author retain-or-remove decision | `docs/tasks/NS-609.md`; `docs/testing/NS-609_ACCEPTANCE.md`; ADR-0026 |
| NS-610 | in_progress | M6.9 reference-aware Research Database and Source archive, restore, permanent-delete, replacement, and reparse lifecycle; no new Research Note behavior | `docs/tasks/NS-610.md`; `docs/testing/NS-610_ACCEPTANCE.md`; ADR-0025; ADR-0026 |
