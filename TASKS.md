...
| NS-609 | paused | M6.8 database-owned evidence-bound Research Note authority and Proposal-gated promotion pass A01-A11; author-only A12 remains open while continued mainline work proceeds by direction | `docs/tasks/NS-609.md`; `docs/testing/NS-609_ACCEPTANCE.md` |
| NS-610 | in_progress | M6.9 reference-aware Research Database, Source, and Research Note archive, restore, permanent-delete, replacement, and reparse lifecycle | `docs/tasks/NS-610.md`; `docs/testing/NS-610_ACCEPTANCE.md`; ADR-0025 |
